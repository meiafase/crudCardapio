...
public class EditarPrato {
	...
	public static void EditarPrato(List<Pedido> listaDePedido) throws IOException {
		int contador = 1;
	    ...
	    while(leitor.hasNext()){
		    ...
		    while(leitorDois.hasNext()){
		        ...
		        if(contador == prato) {
		        	...
		        	nomePratoEditado = ler.nextLine();
		        	nomePratoEditado = ler.nextLine();
		        	System.out.println("Digite o novo preço do prato: ");
		        	precoPratoEditado = ler.nextLine();
		        	gravador.print(precoPratoEditado + "\t"+ nomePratoEditado +"\n");
